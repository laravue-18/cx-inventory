            ...
            <div class="col-md-6">
                ...
                <table class="table table-borderless table-sm">
                    <tbody v-if="product && (!!product.transactions) && product.transactions.length">
                        ...
                        <tr> <td>Model:</td> <td>@{{ product.product_model ? product.product_model.name : '' }}</td> </tr>
                        ...
                        <tr> <td>Location:</td> <td>@{{ product.transactions ? product.transactions[0].location_id : '' }}</td> </tr>
